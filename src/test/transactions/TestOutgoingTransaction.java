...
public class TestOutgoingTransaction
{
	private OutgoingTransaction it;
	private Date d;
	private Product p1;
	private Store s1;
	...
	public void init()
	{
		...
		s1 = new Store("Test Store", "address");

		it = new OutgoingTransaction(s1, d);
	...
	public void testConstructor()
	{
		...
		assertEquals(s1.getID(), it.getTransactionStoreID(), "Store ID was not the same as provided store object");
	...
	public void testToString()
	{
		...
		String str = "";
		String common = it.getTransactionStoreID() + "," + it.getID() + "," + it.getDate() + "," + productList.length + "," + System.lineSeparator();
